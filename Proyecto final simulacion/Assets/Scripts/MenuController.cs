...
void Update()
{
    // Verificar que el objeto no esté siendo destruido y que estemos en la escena correcta
    if (this == null || SceneManager.GetActiveScene().name != "menu")
        return;
    ...
    // Debug de raycast - SOLO si el EventSystem existe
...
void DebugRaycast()
{
    ...
    {
        Debug.LogWarning("EventSystem no está disponible para raycast");
        return;
    }
